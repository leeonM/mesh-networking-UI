    ...
    <div className='h-[100vh] flex flex-col items-center justify-center'>
        ...
        md:w-[30%] pb-6 shadow-xl">
          ...
          <form className='flex flex-col gap-2 w-[80%]'>
            ...
            className='rounded-md border-[1px] p-2 border-gray-300'
            />
            <button className='w-full mt-3 bg-blue-600 text-white p-2 rounded-md'>Login</button>
            <p className='flex cursor-pointer justify-center text-sm'>Don't have an account? Register</p>
          </form>
        </div>
    </div>
  )
